    ...
    <div className="container mx-auto p-4 md:p-8">
      <header className="mb-8">
        ...
        <p className="text-muted-foreground">
          Manage your AgriAssist project configuration and services.
        </p>
      </header>
              ...
              <AccordionContent asChild>
                <CardContent className="pt-2">
                   <div className="flex items-center justify-between p-3 border-b">
                    <Label className="text-sm font-medium">Database Security Rules</Label>
                    <Button variant="outline" size="sm">View Rules</Button>
                  </div>
                   <div className="flex items-center justify-between p-3 border-b">
                    <Label className="text-sm font-medium">Authentication Security</Label>
                    <Button variant="outline" size="sm">Configure</Button>
                  </div>
                   <div className="flex items-center justify-between p-3">
                    <Label className="text-sm font-medium">Users and Roles</Label>
            ...
            <Card>
              ...
              <AccordionContent asChild>
                <CardContent className="pt-2">
                   ...
                   <div className="flex items-center justify-between p-3">
                    <Label className="text-sm font-medium">Terms of Use</Label>
                    <Button variant="outline" size="sm">Edit</Button>
                  </div>
                </CardContent>
              </AccordionContent>
