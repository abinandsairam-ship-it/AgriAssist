...
Based on this information, provide detailed treatment recommendations and best practices to address the issue. Tailor the recommendations to the user's preference for organic or chemical solutions. Provide a detailed, actionable response.`,
});
